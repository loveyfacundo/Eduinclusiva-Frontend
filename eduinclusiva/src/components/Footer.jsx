...
function Footer() {
  return (
    <footer className="bg-gradient-to-br from-purple-50 via-blue-50 to-indigo-50 border-t-2 border-purple-200 shadow-lg">
      <div className="max-w-7xl mx-auto px-6 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10 mb-10">
          {/* Columna 1: EduInclusiva */}
          <div className="lg:col-span-1">
            <div className="flex items-center gap-3 mb-6">
              <div className="bg-gradient-to-br from-purple-600 to-indigo-600 rounded-xl p-3 shadow-md hover:shadow-lg transition-shadow">
          ...
          <div>
            <h3 className="text-gray-900 font-bold text-lg mb-6 relative pb-2">
              Plataforma
              <span className="absolute bottom-0 left-0 w-12 h-0.5 bg-gradient-to-r from-purple-600 to-indigo-600"></span>
            </h3>
            <ul className="space-y-3 text-sm">
              <li>
                <Link to="/caracteristicas" className="text-gray-600 hover:text-purple-600 transition-all duration-200 hover:translate-x-1 inline-block group">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li>
                <Link to="/contacto" className="text-gray-600 hover:text-purple-600 transition-all duration-200 hover:translate-x-1 inline-block group">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm">
              <li>
                <Link to="/acerca" className="text-gray-600 hover:text-purple-600 transition-all duration-200 hover:translate-x-1 inline-block group">
        ...
        <div className="border-t-2 border-purple-200 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <p className="text-sm text-gray-600 font-medium">
              © 2025 <span className="text-purple-600 font-bold">EduInclusiva</span>. Todos los derechos reservados.
            </p>
            ...
            <div className="flex items-center gap-4">
              <a 
                ...
                className="bg-white hover:bg-purple-100 p-3 rounded-xl shadow-sm hover:shadow-md transition-all duration-200 group"
              >
